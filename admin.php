...
<?php
	...
	"music"=>array("file"=>$_POST['music'],"name"=>$_POST['songname'],"status"=>$_POST['songnameon'],"volume"=>$_POST['volume']),"progressbar_color"=>$_POST['color_progress_txt']));
...
<textarea style="margin: -10px 0 0 0;" rows="8" name="description" maxlength="480" id="desc"><?php echo $description; ?></textarea>
</div>
</div>
...
<br><br><span style="font-size: 17px; color: #2d2d2d">- only .ogg files or Youtube Video URLs<br>- (Youtube-URLs have to look like this: https://www.youtube.com/watch?v=XXXXXXXXXXX)<br>- For own Files use the entire URL to the File (http://example.com/split-Load/music/song.ogg)</span>
